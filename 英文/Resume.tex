...
\begin{body}
	\vspace{14pt}
	Master's degree, Software Theory --- GPA 3.61/4.00 \hfill \emph{Sept. 2011 - Jul. 2014(expected)} \\
...
\begin{body}
    ...
    \begin{itemize} \itemsep -0pt
        \item Worked for database group
...
\begin{body}
    ...
    \begin{itemize} \itemsep -0pt
        ...
        \item Construct, manage and maintain laboratory website
    \end{itemize}
\end{body}
\smallskip
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{body}
    ...
    \smallskip
    Third Class Award in ACM Competetion of Youdao Cup  \hfill{} \emph{2011}\\
    \smallskip
